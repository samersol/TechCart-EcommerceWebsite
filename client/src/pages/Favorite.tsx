    ...
    <Container>
      {favoriteProduct?.length > 0 ? (
        ...
        <div className="mx-auto flex max-w-3xl flex-col gap-3 items-center text-center">
          ...
          <Link
            to={"/product"}
            className="w-full mt-2 rounded-md border border-transparent px-8 py-3 text-base font-medium text-grey-900 bg-gray-100 sm:w-auto hover:bg-purple-600 hover:text-white duration-200"
          >
            Add Products
          </Link>
        </div>
