    ...
    <div className="bg-purple-900 rounded-lg">
      ...
      >
        ...
        <button
          //   disabled={loading}
          type="submit"
          className="mt-5 bg-purple-600 w-full py-2 uppercase text-base font-bold tracking-wide text-gray-300 rounded-md hover:text-white hover:bg-purple-800 duration-200"
        >
      ...
      <p className="text-sm leading-6 text-gray-400 text-center -mt-2 py-10">
        ...
        >
          Register
        </button> <br /> <br /> or Sign in as a Guest: <b>guest1@guest.com</b> <br /> Password: <b>guest123</b>
      </p>
      {loading && <Loading />}
    </div>
  );
