...
const ProductCard = ({ item, setSearchText }: Props) => {
  ...
  return (
    <div className="border border-gray-200 rounded-lg p-1 overflow-hidden hover:border-purple-500 duration-200 cursor-pointer">
      <div className="w-full h-60 relative p-2 group">
        <span
          onClick={open}
          className="bg-purple-100 text-purple-900 absolute left-0 right-0 w-16 text-xs text-center py-1 rounded-md font-semibold inline-block z-10"
        >
