  ...
  return (
    <div className="flex py-6">
      ...
      <div
        ...
        className="ml-4 flex-shrink-0 h-20 w-20 sm:w-40 sm:h-40 sm:order-first sm:m-0 sm:mr-6 border border-gray-200 rounded-md hover:border-purple-400 duration-200 cursor-pointer group overflow-hidden"
      >
        <img
