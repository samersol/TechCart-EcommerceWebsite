...
const AddToCartBtn = ({
  ...
  const newClassName = twMerge(
    "bg-[#f7f7f7] uppercase text-xs py-3 text-center rounded-full font-semibold hover:bg-purple-400 hover:text-white hover:scale-105 duration-200 cursor-pointer",
    className
  );
      ...
      {existingProduct ? (
        <div className="flex self-center items-center justify-center gap-2">
          <button
            ...
            className="bg-[#f7f7f7] text-black p-2 border-[1px] border-gray-200 hover:border-purple-400 rounded-full text-sm hover:bg-white duration-200 cursor-pointer"
          >
            <FaMinus />
          </button>
